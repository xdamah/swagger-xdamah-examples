...
public class VanillaDesignJsonTest {
	...
	void savePersonJsonTest() throws Exception {
		...
		List<Tuple<OffsetDateTime, OffsetDateTime>> list = saveJson("vanillaDesignFirst?abc=18", "examples/1.json", this::f1);
	...
	void saveNestedPersonJsonTest() throws Exception {
		...
		List<Tuple<OffsetDateTime, OffsetDateTime>> list = saveJson("vanillaDesignFirst?abc=18", "examples/2.json", this::f2);
		assertEquals(3, list.size());
	}
	
	@Test
	void savePersonJsonWithInvalidAgeTest() throws Exception {
		badRequest("vanillaDesignFirst?abc=18", "examples/1.json", this::invalidAge, "errors/vanInvalidAge.json");
	}
	
	@Test
	void saveNestedPersonJsonWithInvalidAgeTest() throws Exception {
		badRequest("vanillaDesignFirst?abc=18", "examples/2.json", this::invalidAgeInNested, "errors/vanInvalidAgeNested.json");
	}

	@Test
	void savePersonJsonWithInvalidCCTest() throws Exception {
		badRequest("vanillaDesignFirst?abc=18", "examples/1.json", this::invalidCard, "errors/vanBadcc.json");
	}
	
	
	@Test
	void saveNestedPersonJsonWithInvalidCCTest() throws Exception {
		badRequest("vanillaDesignFirst?abc=18", "examples/2.json", this::invalidCardsInNested, "errors/vanBadCCsInNested.json");
	}
	
	
	@Test
	void savePersonJsonWithInvalidEmail1Test() throws Exception {
		badRequest("vanillaDesignFirst?abc=18", "examples/1.json", this::invalidEmail1, "errors/vanInvalidEmail1.json");
	}
	
	
	@Test
	void saveNestedPersonJsonWithInvalidEmail1Test() throws Exception {
		badRequest("vanillaDesignFirst?abc=18", "examples/2.json", this::invalidEmail1InNested, "errors/vanInvalidEmail1Nested.json");
	}
	...
	void savePersonJsonWithInvalidCardAgeEmail1Test() throws Exception {
		badRequest("vanillaDesignFirst?abc=18", "examples/1.json", this::invalidCardAgeEmail1, "errors/vanInalidCCAgeEmail1.json");
	}
	
	@Test
	void saveNestedPersonJsonWithInvalidCardAgeEmail1Test() throws Exception {
		badRequest("vanillaDesignFirst?abc=18", "examples/2.json", this::invalidCardAgeEmail1InNested, "errors/vanInvalidCCAgeEmail1Nested.json");
	}
	
	@Test
	void savePersonJsonWithInvalidAgeAndInvalidAbcTest() throws Exception {
		badRequest("vanillaDesignFirst?abc=5", "examples/1.json", this::invalidAge, "errors/vanInvalidAgeWithInvalidAbc.json");
	}
