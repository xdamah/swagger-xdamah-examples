...
public class Person {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, person.id) && Objects.equals(this.firstName, person.firstName)
				...
				&& Objects.equals(this.email1, person.email1) && Objects.equals(this.age, person.age)
				&& Objects.equals(this.creditCardNumber, person.creditCardNumber)
				&& Objects.equals(this.registrationDate, person.registrationDate)
				&& Objects.equals(this.pic, person.pic) && Objects.equals(this.pics, person.pics)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, firstName, lastName, email, email1, age, creditCardNumber, registrationDate, pic, pics,
				sampleCustomTypeData, someTimeData, anotherPerson, children);
	}
