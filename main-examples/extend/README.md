...
| Link         | Description    |
| :----------- | :------------- |
| [![Not So Basic No Controller__________](https://img.shields.io/badge/Not_So_Basic_No_Controller-grey?style=for-the-badge)](extend-no-controller/README.md)      | Demonstrates above mentioned goal while eliminating controller code.        | 
