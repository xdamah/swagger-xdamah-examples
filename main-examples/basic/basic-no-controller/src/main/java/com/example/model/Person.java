...
public class Person {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, person.id) && Objects.equals(this.firstName, person.firstName)
				...
				Objects.equals(this.registrationDate, person.registrationDate) && Objects.equals(this.pic, person.pic)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, firstName, lastName, email, age, registrationDate, pic, pics, someTimeData,
				anotherPerson, children);
	}
