...
public class CodeFirstPostJsonTest {
	...
	void savePersonJsonTest() throws Exception {
		...
		List<Tuple<OffsetDateTime, OffsetDateTime>> list = saveJson("codefirst/abc", "examples/1.json", this::f1);
	...
	void saveNestedPersonJsonTest() throws Exception {
		...
		List<Tuple<OffsetDateTime, OffsetDateTime>> list = saveJson("codefirst/abc", "examples/2.json", this::f2);
		assertEquals(3, list.size());
	}
	
	@Test
	void savePersonJsonWithInvalidAgeTest() throws Exception {
		badRequest("codefirst/abc", "examples/1.json", this::invalidAge, "errors/cfInvalidAge.json");
	}
	
	@Test
	void saveNestedPersonJsonWithInvalidAgeTest() throws Exception {
		badRequest("codefirst/abc", "examples/2.json", this::invalidAgeInNested, "errors/cfInvalidAgeNested.json");
	}

	@Test
	void savePersonJsonWithInvalidCCTest() throws Exception {
		badRequest("codefirst/abc", "examples/1.json", this::invalidCard, "errors/cfBadcc.json");
	}
	
	
	@Test
	void saveNestedPersonJsonWithInvalidCCTest() throws Exception {
		badRequest("codefirst/abc", "examples/2.json", this::invalidCardsInNested, "errors/cfBadCCsInNested.json");
	}
	
	
	@Test
	void savePersonJsonWithInvalidEmail1Test() throws Exception {
		badRequest("codefirst/abc", "examples/1.json", this::invalidEmail1, "errors/cfInvalidEmail1.json");
	}
	
	
	@Test
	void saveNestedPersonJsonWithInvalidEmail1Test() throws Exception {
		badRequest("codefirst/abc", "examples/2.json", this::invalidEmail1InNested, "errors/cfInvalidEmail1Nested.json");
	}
	...
	void savePersonJsonWithInvalidCardAgeEmail1Test() throws Exception {
		badRequest("codefirst/abc", "examples/1.json", this::invalidCardAgeEmail1, "errors/cfInalidCCAgeEmail1.json");
	}
	
	@Test
	void saveNestedPersonJsonWithInvalidCardAgeEmail1Test() throws Exception {
		badRequest("codefirst/abc", "examples/2.json", this::invalidCardAgeEmail1InNested, "errors/cfInvalidCCAgeEmail1Nested.json");
	}
