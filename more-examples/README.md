...
This README documents whatever steps are necessary to get additional  example applications up and running.
...
* In each project cd [example more-examples/project name]
* for example cd more-examples/01-first-example
